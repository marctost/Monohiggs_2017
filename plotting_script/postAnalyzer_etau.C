...
void make_hist(string input_file, string output_file, string histname_string, string sample_name, string name_ ,  Double_t weight_lumi , bool isNLO, double ngen_, double xsec)
{
  ...
  //***************** Tau id scale factor *****************
  //  Double_t tauID_sf = 0.89;
  //Double_t Zvtx_sf = 0.991;


  // Keep all sf and weights before this ***********************
  ...
  */
  if(histname == "Events_level_"){
    ...
    if(sample_name=="data_obs"){
      myfile.open ("Event_number_etau.csv");
    ...
    else myfile.open ("Event_number_etau.csv", ios::app);
...
int main(int argc, char** argv)
{
  ...
  else if (sample=="TT" or sample=="TTT" or sample=="TTJ" or sample=="TTJets") {xs=831.76; weight=luminosity*xs/ngen;}
  else if (sample=="W") {xs=1; weight=luminosity*xs/ngen;}
  else if (sample=="W1") {xs=1; weight=luminosity*xs/ngen;}
  else if (sample=="W2") {xs=1; weight=luminosity*xs/ngen;}
  else if (sample=="W3") {xs=1; weight=luminosity*xs/ngen;}
  else if (sample=="W4") {xs=1; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_2J" or sample=="WJetsToLNu"){xs=50380.0; weight=luminosity*xs/ngen;} // {xs=50380.0; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT100To200") {xs=1345.0; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT200To400") {xs=359.7; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT400To600") {xs=48.91; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT600To800") {xs=12.04; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT800To1200") {xs=5.52; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT1200To2500") {xs=1.33; weight=luminosity*xs/ngen;}
  else if (sample=="WJetsToLNu_HT2500ToInf") {xs=0.0322; weight=luminosity*xs/ngen;}
  ...
  else if (sample=="WplusH125" or sample=="WPlusHToTauTau") {xs=0.052; weight=luminosity*xs/ngen;}
  else if (sample=="WminusH125" or sample=="WMinusHToTauTau") {xs=0.0334; weight=luminosity*xs/ngen;}
  ...
  else if (sample=="WWTo1L1Nu2Q" or sample=="WWToLNuQQ") {xs=10.71; weight=luminosity*xs/ngen;}
  ...
  else if (sample=="WWTo2L2Nu_DoubleScattering") {xs=1.62; weight=luminosity*xs/ngen;}
  ...
  else if (sample=="EWKWMinus" or sample=="EWKWMinus2Jets") {xs=20.25; weight=luminosity*xs/ngen;}
...
//  plotnames.push_back(TString(""));
  ...
  histnames.push_back("Electron_Pt_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron #it{p}_{T} [GeV]"));
  plotnames.push_back(TString("elePt"));

  histnames.push_back("Electron_En_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron #it{energy} [GeV]"));
  plotnames.push_back(TString("eleEn"));

  histnames.push_back("Electron_SCeta_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron SC  #eta"));
  plotnames.push_back(TString("eleSCEta"));

  histnames.push_back("Electron_SCphi_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron SC #phi"));
  plotnames.push_back(TString("eleSCPhi"));

  histnames.push_back("Electron_eta_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron #eta"));
  plotnames.push_back(TString("eleEta"));

  histnames.push_back("Electron_phi_");
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  ...
  leg_xoffsets.push_back(0.);
  leg_yoffsets.push_back(0.);
  xaxis_titles.push_back(TString("Electron-MET M_{T} [GeV]"));
...
*/
  ...
  */
  ...
  TDirectory *ptEle = f_output->mkdir("Electron_Pt_");
  TDirectory *enEle = f_output->mkdir("Electron_En_");
  TDirectory *phiEle = f_output->mkdir("Electron_phi_");
  TDirectory *etaEle = f_output->mkdir("Electron_eta_");
  TDirectory *SCPhiEle = f_output->mkdir("Electron_SCphi_");
  TDirectory *SCEtaEle = f_output->mkdir("Electron_SCeta_");
  ...
  cout<<"************************ works till here, after TDir *********************"<<endl;


  f_output->Close();

  // cout<<"This workks too before makehist" <<endl;
  make_hist(input, output, "Electron_En_", sample, name, weight, true, ngen , xs);
  make_hist(input, output, "Tau_En_", sample , name,weight, true, ngen , xs);
  make_hist(input, output, "Electron_eta_", sample ,  name,weight, true, ngen , xs);
  make_hist(input, output, "Tau_eta_", sample ,name,weight, true, ngen , xs);
  make_hist(input, output, "Electron_Pt_", sample ,name,weight, true, ngen , xs);
  make_hist(input, output, "Tau_Pt_", sample ,name,weight, true, ngen , xs);
  make_hist(input, output, "Electron_phi_", sample ,name,weight, true, ngen , xs);
  ...
  cout<<"************************ works till here, after make_hist *********************"<<endl;
