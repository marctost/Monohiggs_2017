...
// Thu Jun 14 10:27:05 2018 by ROOT version 6.10/09
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: /hdfs/store/user/jmadhusu/Data_2017/monoHiggs_data/SingleMuon/crab_sMu_dataset1/180608_102330/0000/ggtree_data_210.root
//////////////////////////////////////////////////////////

#ifndef post_analyzer_h
#define post_analyzer_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   post_analyzer(const char* file1);
   virtual ~post_analyzer();
...
#ifdef post_analyzer_cxx
post_analyzer::post_analyzer(const char* file1)  
{
...
Int_t post_analyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t post_analyzer::LoadTree(Long64_t entry)
{
...
void post_analyzer::Init(TTree *tree)
{
...
void post_analyzer::Show(Long64_t entry)
{
...
Int_t post_analyzer::Cut(Long64_t entry)
{
