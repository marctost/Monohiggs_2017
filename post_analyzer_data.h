...
#ifndef post_analyzer_data_h
#define post_analyzer_data_h
...
post_analyzer_data::~post_analyzer_data()
{
    if (!fChain) return;
...
Long64_t post_analyzer_data::LoadTree(Long64_t entry)
{
...
Bool_t post_analyzer_data::Notify()
{
...
void post_analyzer_data::Show(Long64_t entry)
{
...
Int_t post_analyzer_data::Cut(Long64_t entry)
{
...
#endif // #ifdef post_analyzer_data_cxx
