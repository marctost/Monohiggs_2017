...
void post_analyzer_data::Loop(Long64_t maxevents, int reportEvery, const char* save_name, const char* final_state){
	if (fChain==0) return;
	...
	Long64_t nbytes = 0, nb = 0;
   	...
   	for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++) {
        ...
        fillEvent(1,1,lept_num_1, lept_num_2);
        
        // met filter selection
        if (!(metFilters==0)) continue;
        fillEvent(2,1,lept_num_1, lept_num_2);
        ...
        fillEvent(3,1,lept_num_1, lept_num_2);
        ...
        fillEvent(4,1,lept_num_1, lept_num_2);
        ...
        fillEvent(5,1,lept_num_1, lept_num_2);
        ...
        fillEvent(6,1,lept_num_1, lept_num_2);
        
        // charge requirement selection
        if (!(charge_1+charge_2==0)) continue;
        fillEvent(7,1,lept_num_1, lept_num_2);
        ...
        fillEvent(8,1,lept_num_1, lept_num_2);
        
        // bjet selection
        if (BjetVeto(nJet, jetBtag)==true) continue;
        fillEvent(9,1,lept_num_1, lept_num_2);
